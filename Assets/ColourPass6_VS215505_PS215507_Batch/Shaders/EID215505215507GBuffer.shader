Shader "EID/URP/VS215505_PS215507_GBuffer"
{
    Properties
    {
        ...
        _Res29 ("res29 叠加颜色 Binding6", 2D) = "black" {}
        [Header(RenderDoc_PS_uniforms32_c00_c30)]
        ...
        _EID215507MipBias ("uniforms17 全局纹理 Mip Bias", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VS215505_PS215507_UniversalGBuffer"
            ...
            #pragma vertex EID215505Vertex
            #pragma fragment EID215507Fragment
            #include "EID215505215507GBuffer.hlsl"
            ENDHLSL
        }
    }
}
