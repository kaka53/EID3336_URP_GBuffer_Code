...
StructuredBuffer<EID215845Instance> _EID215845Instances;

float4x4 EID215845ObjectToWorldMatrix()
{
    EID215845Instance rec = _EID215845Instances[(uint)max(VSglXInstanceIndex, 0)];
    return float4x4(
...
struct EID215845VSInputInternal
{
...
struct EID215845VertexVaryings
{
...
void vert_main()
{
    float4x4 objectToWorld = EID215845ObjectToWorldMatrix();
...
EID215845VertexVaryings EID215845VSGeneratedMain(EID215845VSInputInternal stage_input)
{
    ...
    vert_main();
    EID215845VertexVaryings stage_output;
...
EID215845VertexVaryings EID215845VertexMain(EID215845VertexInput i)
{
    EID215845VSInputInternal x;
    x.VSX3 = i.position;
    x.VSX4 = i.normal;
    x.VSX5 = i.tangent;
    x.VSX6 = i.extra;
    ...
    return EID215845VSGeneratedMain(x);
}
