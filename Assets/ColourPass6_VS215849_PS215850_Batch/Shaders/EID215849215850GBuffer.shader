Shader "EID/URP/VS215849_PS215850_GBuffer"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VS215849_PS215850_UniversalGBuffer"
            ...
            #pragma vertex EID215849Vertex
            #pragma fragment EID215850Fragment
            #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Core.hlsl"
            #include "EID3863VegetationVS.hlsl"
            #include "EID3863VegetationPS.hlsl"
            EID3863VertexVaryings EID215849Vertex(EID3863VertexInput i)
            {
                return EID3863VertexMain(i);
            }
            EID3863GBufferOutput EID215850Fragment(EID3863FragmentVaryings i, bool frontFace : SV_IsFrontFace)
            {
