Shader "EID/URP/VS215549_PS215550_GBuffer"
{
    Properties
    {
        ...
        _Res27 ("res27 额外通道 Binding4", 2D) = "white" {}
        [Header(RenderDoc_PS_uniforms30_c00_c26)]
        ...
        _P23 ("c23 灯光混合与白混", Vector) = (1,1,0,0)
        _P24 ("c24 捕获局部参数", Vector) = (0,0,0,0)
        _P25 ("c25 overlay 混色", Vector) = (4,3.670588,0.831373,1)
        _P26 ("c26 overlay 权重与模式", Vector) = (1,4,0,0)
        ...
        _EID215550MipBias ("uniforms17 全局纹理 Mip Bias", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VS215549_PS215550_UniversalGBuffer"
            ...
            #pragma vertex EID215549Vertex
            #pragma fragment EID215550Fragment
            #include "EID215549215550GBuffer.hlsl"
            ENDHLSL
        }
    }
}
