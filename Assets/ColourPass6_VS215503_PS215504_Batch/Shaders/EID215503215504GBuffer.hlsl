#ifndef EID215503_215504_GBUFFER_INCLUDED
#define EID215503_215504_GBUFFER_INCLUDED
...
float _EID215504MipBias;
float _UseBakedSkinning;
CBUFFER_END

struct Attributes215503
{
...
float3 DecodeOctNormal215503(uint packed)
{
...
float4 DecodePackedTangent215503(uint packed, float3 n)
{
...
Varyings215503 EID215503Vertex(Attributes215503 input)
{
    Varyings215503 o;
    uint packed = asuint(input.packedNormal.x);
    bool packedBasis = (packed & 0x40000000u) != 0u;
    float3 decodedNormalOS = packedBasis ? DecodeOctNormal215503(packed) : input.packedNormal.xyz;
    float4 decodedTangentOS = packedBasis ? DecodePackedTangent215503(packed, decodedNormalOS) : input.input2;
...
GBufferOutput215504 EID215504Fragment(Varyings215503 input, bool isFrontFace : SV_IsFrontFace)
{
    GBufferOutput215504 o;
