Shader "EID/URP/VS215503_PS215504_GBuffer"
{
    Properties
    {
        ...
        _P25 ("c25 AO顶点混 叠加开关", Vector) = (0,0,0,0)
        _P26 ("c26 叠加smoothstep", Vector) = (0,0,0,0)
        ...
        _EID215504MipBias ("uniforms18 全局纹理 Mip Bias", Float) = 0
        _UseBakedSkinning ("Captured ssbo38 skin baked into VSInput", Float) = 0
    }
    SubShader
    {
        ...
        Pass
        {
            Name "VS215503_PS215504_UniversalGBuffer"
            ...
            #pragma vertex EID215503Vertex
            #pragma fragment EID215504Fragment
            #include "EID215503215504GBuffer.hlsl"
            ENDHLSL
        }
    }
}
