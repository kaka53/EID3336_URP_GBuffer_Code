Shader "EID/URP/VS215477_PS215478_GBuffer"
{
    Properties
    {
        ...
        _EID215478MipBias ("uniforms6 全局纹理 Mip Bias", Float) = 0
        _UseBakedSkinning ("Captured ssbo28 skin baked into VSInput", Float) = 0
    }
    SubShader
    {
        ...
        Pass
        {
            Name "VS215477_PS215478_UniversalGBuffer"
            ...
            #pragma vertex EID215477Vertex
            #pragma fragment EID215478Fragment
            #include "EID215477215478GBuffer.hlsl"
            ENDHLSL
        }
    }
}
