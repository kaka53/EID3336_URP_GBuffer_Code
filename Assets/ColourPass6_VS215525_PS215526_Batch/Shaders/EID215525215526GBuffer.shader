Shader "EID/URP/VS215525_PS215526_GBuffer"
{
    Properties
    {
        ...
        _P08 ("c08 基础颜色乘色", Vector) = (0.215861,0.215861,0.215861,1)
        ...
        _P23 ("c23 额外混合开关", Vector) = (0,0,1,0.311)
        _P24 ("c24 额外材质衰减与遮罩选择", Vector) = (0,1,0,0)
        _P25 ("c25 额外色倍率", Vector) = (1,0,0,0)
        _P26 ("c26 额外颜色乘色", Vector) = (0.33645,0.33645,0.33645,0.862745)
        ...
        _P34 ("c34 叠加层0 RGB与权重", Vector) = (0.046104,0.046104,0.046104,0.564706)
        _P35 ("c35 叠加层1 RGB与权重", Vector) = (0.12884,0.12884,0.161074,0.635294)
        _P36 ("c36 叠加层2 RGB与权重", Vector) = (0.049008,0.049008,0.049008,0.580392)
        ...
        _EID215526MipBias ("uniforms21 全局纹理 Mip Bias", Float) = 0
    }
    SubShader
    {
        ...
        Pass
        {
            Name "VS215525_PS215526_UniversalGBuffer"
            ...
            #pragma vertex EID215525Vertex
            #pragma fragment EID215526Fragment
            #include "EID215525215526GBuffer.hlsl"
            ENDHLSL
        }
    }
}
