Shader "EID/URP/VS215493_PS215494_GBuffer"
{
    Properties
    {
        ...
        [Header(RenderDoc_PS_uniforms28_c00_c25)]
        ...
        _P24 ("c24 overlay 混色", Vector) = (1,1,1,1)
        _P25 ("c25 overlay 权重与灯光混合", Vector) = (0,0,0,0)
        ...
        _EID215494MipBias ("uniforms17 全局纹理 Mip Bias", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VS215493_PS215494_UniversalGBuffer"
            ...
            #pragma vertex EID215493Vertex
            #pragma fragment EID215494Fragment
            #include "EID215493215494GBuffer.hlsl"
            ENDHLSL
        }
    }
}
