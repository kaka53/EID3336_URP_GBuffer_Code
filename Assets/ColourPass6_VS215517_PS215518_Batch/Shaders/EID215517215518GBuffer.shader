Shader "EID/URP/VS215517_PS215518_GBuffer"
{
    Properties
    {
        [Header(RenderDoc_Unique_Textures)]
        _Res32 ("res32 基础颜色 Binding4", 2D) = "white" {}
        _Res34 ("res34 切线法线 Binding2", 2D) = "bump" {}
        _Res36 ("res36 三层叠加 Binding3", 2D) = "white" {}
        [Header(RenderDoc_PS_uniforms38_c00_c33)]
        ...
        _P22 ("c22 叠加UV混合与层0粗糙度", Vector) = (1,0.777,0,0)
        _P23 ("c23 层1层2粗糙度", Vector) = (1,0,0,1)
        _P24 ("c24 叠加材质Y", Vector) = (0,0,0,0)
        _P25 ("c25 叠加阈值 xy", Vector) = (0,0,0,0)
        _P26 ("c26 叠加阈值 z", Vector) = (0,0,0,0)
        _P27 ("c27 叠加层0 RGB+w", Vector) = (0,0,0,0)
        _P28 ("c28 叠加层1 RGB+w", Vector) = (0,0,0,0)
        _P29 ("c29 叠加层2 RGB+w", Vector) = (0,0,0,0)
        ...
        _EID215518MipBias ("uniforms20 全局纹理 Mip Bias", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VS215517_PS215518_UniversalGBuffer"
            ...
            #pragma vertex EID215517Vertex
            #pragma fragment EID215518Fragment
            #include "EID215517215518GBuffer.hlsl"
            ENDHLSL
        }
    }
}
