Shader "EID/URP/VS215521_PS215522_GBuffer"
{
    Properties
    {
        [Header(RenderDoc_Unique_Textures)]
        _Res28 ("res28 基础颜色 Binding7", 2D) = "white" {}
        _Res30 ("res30 切线法线 Binding2", 2D) = "bump" {}
        _Res32 ("res32 额外遮罩 Binding3", 2D) = "white" {}
        _Res33 ("res33 额外混合 Binding6", 2D) = "white" {}
        _Res34 ("res34 额外颜色 Binding5", 2D) = "white" {}
        _Res35 ("res35 额外法线 Binding4", 2D) = "bump" {}
        [Header(RenderDoc_PS_uniforms37_c00_c28)]
        ...
        _P11 ("c11 基础颜色UV", Vector) = (10,10,0,0)
        ...
        _P22 ("c22 额外轴 混合偏置 UV缩放 法线强度", Vector) = (2,1,8,1.3)
        _P23 ("c23 额外混合开关", Vector) = (0,0,1,0.426)
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VS215521_PS215522_UniversalGBuffer"
            ...
            #pragma vertex EID215521Vertex
            #pragma fragment EID215522Fragment
            #include "EID215521215522GBuffer.hlsl"
            ENDHLSL
        }
    }
}
