#ifndef EID215519_215520_GBUFFER_INCLUDED
...
float4 _P44; float4 _P45; float4 _P46; float4 _P47;
...
GBufferOutput215520 EID215520Fragment(Varyings215519 input, bool isFrontFace : SV_IsFrontFace)
{
    ...
    layered = lerp(layered, float4(layer2s.xyz * _P44.xyz, layerRough.y), weights.z);
    layered = lerp(layered, float4(layer1s.xyz * _P43.xyz, layerRough.x), weights.y);
