#ifndef EID239789_239790_GBUFFER_INCLUDED
#define EID239789_239790_GBUFFER_INCLUDED
...
float4 DecodePackedTangent239789(uint packed, float3 n)
{
...
Varyings239789 EID239789Vertex(Attributes239789 input)
{
    Varyings239789 o;
    uint packed = asuint(input.packedNormal.x);
    bool packedBasis = (packed & 0x40000000u) != 0u;
    float3 decodedNormalOS = packedBasis ? DecodeOctNormal239789(packed) : input.packedNormal.xyz;
    float4 decodedTangentOS = packedBasis ? DecodePackedTangent239789(packed, decodedNormalOS) : input.input3;
...
GBufferOutput239790 EID239790Fragment(Varyings239789 input, bool isFrontFace : SV_IsFrontFace)
{
    GBufferOutput239790 o;
