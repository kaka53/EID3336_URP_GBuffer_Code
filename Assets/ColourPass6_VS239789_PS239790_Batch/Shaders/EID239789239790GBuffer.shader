Shader "EID/URP/VS239789_PS239790_GBuffer"
{
    Properties
    {
        ...
        _P01 ("c01 child4-7 双面法线在 y", Vector) = (0,0,0,0)
        ...
        _P12 ("c12 unused clip slot", Vector) = (0,0,0,0)
        ...
        _EID239790MipBias ("uniforms16 全局纹理 Mip Bias", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VS239789_PS239790_UniversalGBuffer"
