...
public sealed class EID215841InstanceBinder : MonoBehaviour
{
    ...
    void BindBuffer()
    {
        ...
        if (material.HasProperty("_CardVertexCount"))
            material.SetFloat("_CardVertexCount", profile.vertexCount);
    ...
    void AttachBuffer()
    {
        ...
        material.SetBuffer("_EID215841Instances", instances);
    }
