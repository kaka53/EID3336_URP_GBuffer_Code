Shader "EID/URP/VS215481_PS215482_GBuffer"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VS215481_PS215482_UniversalGBuffer"
            ...
            #pragma vertex EID215481Vertex
            #pragma fragment EID215482Fragment
            #include "EID215481215482GBuffer.hlsl"
            ENDHLSL
        }
    }
}
