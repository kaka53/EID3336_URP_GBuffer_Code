Shader "EID/URP/VS215539_PS215540_GBuffer"
{
    Properties
    {
        ...
        _Res31 ("res31 额外贴图 Binding3", 2D) = "white" {}
        [Header(RenderDoc_PS_uniforms33_c00_c27)]
        ...
        _P23 ("c23 额外混合 通道 法线 混合量", Vector) = (1,0,1,0.596)
        _P24 ("c24 距离近远 额外UV混合 色倍率", Vector) = (750,800,0,1)
        _P25 ("c25 额外颜色", Vector) = (0,0,0,0)
        _P26 ("c26 额外UV ST", Vector) = (3,3,0,0)
        _P27 ("c27 捕获局部参数", Vector) = (0,0,0,0)
        _InstanceMeta ("uniforms35 实例材质元数据", Vector) = (0,0,0,0)
        _InstanceStateYZ ("uniforms23 child1.yz + child5.x", Vector) = (0,0,0,0)
        _EID215540MipBias ("uniforms20 全局纹理 Mip Bias", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VS215539_PS215540_UniversalGBuffer"
            ...
            #pragma vertex EID215539Vertex
            #pragma fragment EID215540Fragment
            #include "EID215539215540GBuffer.hlsl"
            ENDHLSL
        }
    }
}
