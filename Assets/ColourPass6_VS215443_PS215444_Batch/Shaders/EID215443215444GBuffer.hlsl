...
Varyings215443 EID215443Vertex(Attributes215443 input)
{
    ...
    float3 decodedNormalOS = packedBasis ? DecodeOctNormal215443(packed) : input.packedNormal.xyz;
    float4 decodedTangentOS = packedBasis ? DecodePackedTangent215443(packed, decodedNormalOS) : input.input3;
...
GBufferOutput215444 EID215444Fragment(Varyings215443 input, bool isFrontFace : SV_IsFrontFace)
{
    ...
    float alpha = albedoSample.a * _P06.w;
    clip(alpha - _P02.y);
