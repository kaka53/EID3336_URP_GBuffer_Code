#ifndef EID215452_215453_GBUFFER_INCLUDED
#define EID215452_215453_GBUFFER_INCLUDED
...
float4 DecodePackedTangent215452(uint packed, float3 n)
{
...
Varyings215452 EID215452Vertex(Attributes215452 input)
{
    Varyings215452 o;
    uint packed = asuint(input.packedNormal.x);
    bool packedBasis = (packed & 0x40000000u) != 0u;
    float3 decodedNormalOS = packedBasis ? DecodeOctNormal215452(packed) : input.packedNormal.xyz;
    float4 decodedTangentOS = packedBasis ? DecodePackedTangent215452(packed, decodedNormalOS) : input.input3;
