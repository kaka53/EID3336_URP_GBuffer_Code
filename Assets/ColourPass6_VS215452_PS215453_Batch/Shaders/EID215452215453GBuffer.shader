Shader "EID/URP/VS215452_PS215453_GBuffer"
{
    Properties
    {
        ...
        [Header(RenderDoc_PS_uniforms24_19xfloat4)]
        ...
        _P13 ("c13 child34", Vector) = (1,1,0,0)
        ...
        _EID215453MipBias ("uniforms16 全局纹理 Mip Bias", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VS215452_PS215453_UniversalGBuffer"
            ...
            #pragma vertex EID215452Vertex
            #pragma fragment EID215453Fragment
            #include "EID215452215453GBuffer.hlsl"
            ENDHLSL
        }
    }
}
