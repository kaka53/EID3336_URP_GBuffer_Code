Shader "EID/URP/VS239454_PS239455_GBuffer"
{
    Properties
    {
        ...
        _EID239455MipBias ("uniforms17 全局纹理 Mip Bias", Float) = 0
        _EID239455GlobalY ("uniforms17 child20.y", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VS239454_PS239455_UniversalGBuffer"
            ...
            #pragma vertex EID239454Vertex
            #pragma fragment EID239455Fragment
            #include "EID239454239455GBuffer.hlsl"
            ENDHLSL
        }
    }
}
