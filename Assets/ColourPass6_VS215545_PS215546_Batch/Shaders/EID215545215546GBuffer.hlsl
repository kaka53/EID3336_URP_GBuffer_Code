#ifndef EID215545_215546_GBUFFER_INCLUDED
#define EID215545_215546_GBUFFER_INCLUDED
...
float _EID215546MipBias;
float _UseBakedSkinning;
CBUFFER_END

struct Attributes215545
{
...
float3 DecodeOctNormal215545(uint packed)
{
...
float4 DecodePackedTangent215545(uint packed, float3 n)
{
...
Varyings215545 EID215545Vertex(Attributes215545 input)
{
    Varyings215545 o;
    uint packed = asuint(input.packedNormal.x);
    bool packedBasis = (packed & 0x40000000u) != 0u;
    float3 decodedNormalOS = packedBasis ? DecodeOctNormal215545(packed) : input.packedNormal.xyz;
    float4 decodedTangentOS = packedBasis ? DecodePackedTangent215545(packed, decodedNormalOS) : input.input2;
...
GBufferOutput215546 EID215546Fragment(Varyings215545 input, bool isFrontFace : SV_IsFrontFace)
{
    GBufferOutput215546 o;
    ...
    float4 albedoSample = SAMPLE_TEXTURE2D_BIAS(_Res31, sampler_Res31, uvAlbedo, _EID215546MipBias);
    float4 normalSample = SAMPLE_TEXTURE2D_BIAS(_Res33, sampler_Res33, uvNormal, _P03.y + _EID215546MipBias);
