Shader "EID/URP/VS218872_PS218873_GBuffer"
{
    Properties
    {
        ...
        _Res32 ("res32 VS field Binding3", 2D) = "gray" {}
        _Res33 ("res33 VS field Binding1", 2D) = "gray" {}
        _Res34 ("res34 VS wind noise Binding0", 2D) = "gray" {}
        [Header(RenderDoc_PS_uniforms30_352B)]
        _P00 ("c00 child0-3", Vector) = (0,0,0,0)
        _P01 ("c01 法线强度 child4 / 双面 child6", Vector) = (1,0,0,0)
        _P02 ("c02 loc3 AO/wrap child8-9 AO child10 粗糙度A child11", Vector) = (1,0,0.2,0)
        _P03 ("c03 粗糙度B child12", Vector) = (1,0,0,0)
        _P04 ("c04 materialY child16 距离衰减 child18 自发光 child19", Vector) = (0.252,0,0,0.2)
        ...
        _P16 ("c16 wind child49-52", Vector) = (1,5,0,0.5)
        _P17 ("c17 wind child53-56", Vector) = (0,0,10.8,0)
        _P18 ("c18 wind child57-60", Vector) = (0.5,1.2,0.11,2.66)
        _P19 ("c19 wind child61-64", Vector) = (0,0.45,0.1,0)
        _P20 ("c20 wind child65-68", Vector) = (1,0.06,7.5,0.05)
        _P21 ("c21 wind child69-72", Vector) = (1.8,0,0,0)
        ...
        _EID218873MipBias ("uniforms19 全局纹理 Mip Bias", Float) = -1
    }
    SubShader
    {
        ...
        Pass
        {
            Name "VS218872_PS218873_UniversalGBuffer"
            ...
            #pragma vertex EID218872Vertex
            #pragma fragment EID218873Fragment
            #include "EID218872218873GBuffer.hlsl"
            ENDHLSL
        }
    }
}
