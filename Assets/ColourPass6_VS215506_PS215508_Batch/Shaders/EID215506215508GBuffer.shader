Shader "EID/URP/VS215506_PS215508_GBuffer"
{
    Properties
    {
        [Header(RenderDoc_Unique_Textures)]
        _Res31 ("res31 基础颜色 Binding5", 2D) = "white" {}
        _Res33 ("res33 切线法线 Binding3", 2D) = "bump" {}
        _Res35 ("res35 粗糙度AO Binding4", 2D) = "white" {}
        [Header(RenderDoc_PS_uniforms38_c00_c28)]
        ...
        _EID215508MipBias ("uniforms20 全局纹理 Mip Bias", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VS215506_PS215508_UniversalGBuffer"
            ...
            #pragma vertex EID215506Vertex
            #pragma fragment EID215508Fragment
            #include "EID215506215508GBuffer.hlsl"
            ENDHLSL
        }
    }
}
