#ifndef EID215447_215448_GBUFFER_INCLUDED
#define EID215447_215448_GBUFFER_INCLUDED
...
float4 DecodePackedTangent215447(uint packed, float3 n)
{
...
Varyings215447 EID215447Vertex(Attributes215447 input)
{
    Varyings215447 o;
    uint packed = asuint(input.packedNormal.x);
    bool packedBasis = (packed & 0x40000000u) != 0u;
    float3 decodedNormalOS = packedBasis ? DecodeOctNormal215447(packed) : input.packedNormal.xyz;
    float4 decodedTangentOS = packedBasis ? DecodePackedTangent215447(packed, decodedNormalOS) : input.input3;
