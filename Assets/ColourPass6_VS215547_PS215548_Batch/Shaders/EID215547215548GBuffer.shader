Shader "EID/URP/VS215547_PS215548_GBuffer"
{
    Properties
    {
        ...
        [Header(RenderDoc_PS_uniforms44_c00_c31)]
        ...
        _P23 ("c23 额外轴 混合偏置 UV缩放 法线强度", Vector) = (1,1,0.61,0.46)
        _P24 ("c24 额外混合开关", Vector) = (0,0,1,0)
        _P25 ("c25 额外材质衰减与遮罩选择", Vector) = (0,1,0,0)
        _P26 ("c26 额外色倍率", Vector) = (1,0,0,0)
        _P27 ("c27 额外颜色乘色", Vector) = (1,1,1,1)
        _P28 ("c28 额外UV偏移", Vector) = (0,0,0,0)
        _P29 ("c29 捕获局部参数", Vector) = (5.35,0,0.45,0)
        _P30 ("c30 捕获局部参数", Vector) = (0.5,0.3,1,1)
        ...
        _EID215548MipBias ("uniforms22 全局纹理 Mip Bias", Float) = -1
    }
    SubShader
    {
        ...
        Pass
        {
            Name "VS215547_PS215548_UniversalGBuffer"
            ...
            #pragma vertex EID215547Vertex
            #pragma fragment EID215548Fragment
            #include "EID215547215548GBuffer.hlsl"
            ENDHLSL
        }
    }
}
