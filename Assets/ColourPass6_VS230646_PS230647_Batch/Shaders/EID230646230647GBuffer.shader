Shader "EID/URP/VS230646_PS230647_GBuffer"
{
    Properties
    {
        [Header(RenderDoc_Unique_Textures)]
        _Res23 ("res23 基础颜色 Binding9", 2D) = "white" {}
        _Res25 ("res25 切线法线 Binding5", 2D) = "bump" {}
        _Res27 ("res27 材质通道 Binding6", 2D) = "white" {}
        _Res29 ("res29 叠加 Binding8", 2D) = "white" {}
        _Res31 ("res31 层混合 Binding7", 2D) = "black" {}
        [Header(RenderDoc_PS_uniforms34_c00_c20)]
        ...
        _P16 ("c16 层权重与粗糙度混", Vector) = (0,0,0,0)
        _P17 ("c17 层色A", Vector) = (0,0,0,0)
        _P18 ("c18 层色B", Vector) = (0,0,0,0)
        _P19 ("c19 层色C", Vector) = (0,0,0,0)
        ...
        _EID230647MipBias ("uniforms17 全局纹理 Mip Bias", Float) = 0
        _EID230647GlobalY ("uniforms17 child20.y", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VS230646_PS230647_UniversalGBuffer"
            ...
            #pragma vertex EID230646Vertex
            #pragma fragment EID230647Fragment
            #include "EID230646230647GBuffer.hlsl"
            ENDHLSL
        }
    }
}
