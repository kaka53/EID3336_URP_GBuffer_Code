Shader "EID/URP/VS229074_PS229075_GBuffer"
{
    Properties
    {
        ...
        _EID229075MipBias ("uniforms17 全局纹理 Mip Bias", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VS229074_PS229075_UniversalGBuffer"
            ...
            #pragma vertex EID229074Vertex
            #pragma fragment EID229075Fragment
            #include "EID229074229075GBuffer.hlsl"
            ENDHLSL
        }
    }
}
