...
RWByteAddressBuffer _44 : register(u23);
SamplerState _15 : register(s1);
SamplerState _16 : register(s3);
SamplerState _17 : register(s0);
SamplerState _18 : register(s2);
Texture2D<float4> _29 : register(t14);
Texture2D<float4> _30 : register(t17);
Texture2D<float4> _31 : register(t8);
Texture2D<float4> _32 : register(t5);
Texture2D<float4> _33 : register(t16);
Texture2DArray<float4> _34 : register(t7);
Texture2DArray<float4> _35 : register(t13);
Texture2D<float4> _36 : register(t6);
Texture2D<float4> _37 : register(t15);
Texture2D<float4> _38 : register(t12);
Texture2D<float4> _39 : register(t11);
Texture2D<float4> _40 : register(t10);
Texture2D<float4> _41 : register(t9);
SamplerState _42 : register(s4);
...
struct SPIRV_Cross_Output
{
    ...
    float4 _9 : SV_Target1;
    float4 _6 : SV_Target2;
    float4 _7 : SV_Target3;
    float4 _8 : SV_Target4;
};

void frag_main()
{
    float4 _211 = float4((_4.x * 2.0f) - 1.0f, 1.0f - (2.0f * _4.y), 0.0f, 1.0f);
    _211.z = _36.SampleLevel(_18, _4, 0.0f).x;
    float4 _220 = mul(_11_m6, _211);
    float3 _224 = _220.xyz / _220.w.xxx;
    float3 _225 = _224.xyz;
    float4 _244 = mul(_11_m15, float4((_225 - _11_m11.xyz) + (_11_m11.xyz - _11_m21.xyz), 1.0f));
    ...
    do
    {
        ...
        if (_300)
        {
            ...
            if (_360)
            {
                ...
                float4 _388 = round(_37.SampleLevel(_15, (clamp(_354 * _365, 0.5f.xx, (_365 - 0.5f).xx) + float2(float(_327 & 1023u), float((_327 >> 10u) & 1023u))) * _22_m6.w, floor(clamp(lerp(_349, _353, 0.449999988079071044921875f), 0.0f, _330))) * 255.0f);
            ...
            if (_395)
            {
                _424 = _41.SampleLevel(_15, ((clamp(frac(_354 * exp2(_22_m6.x - _393.z)) * _22_m6.y, 0.5f.xx, (_22_m6.y - 0.5f).xx) + _22_m16.xx) + (_393.xy * _22_m15)) * _22_m6.z, 0.0f).z;
            }
            else
            {
                _424 = 1.0f;
        ...
        float2 _536 = (_29.SampleLevel(_16, ((((((_437 - float2((_438 >> _486) << _486)) / float(1 << (_484 & 31)).xx).xyxy * _22_m0.xxyy) + (float2(float(_501 & (_22_m5.y - 1)), float(_501 >> (_22_m5.z & 31))) * _22_m4.w).xyxy) + _22_m1.xxyy) * float2(1.0f, _22_m14).xyxy).xy, 0.0f).xy * 2.0f) - 1.0f.xx;
        ...
        for (;;)
        {
            if ((_590 < 8u) && _588)
            {
                ...
                if (_612)
                {
                    ...
                    float4 _668 = round(_37.SampleLevel(_15, (clamp(_602 * _645, 0.5f.xx, (_645 - 0.5f).xx) + float2(float(_639 & 1023u), float((_639 >> 10u) & 1023u))) * _22_m6.w, floor(clamp(lerp(_429, _428, 0.449999988079071044921875f), 0.0f, float(_641)))) * 255.0f);
                ...
                if (_675)
                {
                    float4 _706 = _41.SampleLevel(_15, ((clamp(frac(_602 * exp2(_22_m6.x - _673.z)) * _22_m6.y, 0.5f.xx, (_22_m6.y - 0.5f).xx) + _22_m16.xx) + (_673.xy * _22_m15)) * _22_m6.z, 0.0f);
                    _709 = _706.x;
                    _710 = _706.z;
                }
                else
        ...
        for (uint _740 = 0u; (_740 < 3u) && _738; _733 = _734, _736 = _737, _738 = _739, _740++)
        {
            ...
            if (_760)
            {
                ...
                float4 _816 = round(_37.SampleLevel(_15, (clamp(_750 * _793, 0.5f.xx, (_793 - 0.5f).xx) + float2(float(_787 & 1023u), float((_787 >> 10u) & 1023u))) * _22_m6.w, floor(clamp(lerp(_429, _428, 0.449999988079071044921875f), 0.0f, float(_789)))) * 255.0f);
            ...
            if (_823)
            {
                float4 _854 = _41.SampleLevel(_15, ((clamp(frac(_750 * exp2(_22_m6.x - _821.z)) * _22_m6.y, 0.5f.xx, (_22_m6.y - 0.5f).xx) + _22_m16.xx) + (_821.xy * _22_m15)) * _22_m6.z, 0.0f);
                _857 = _854.x;
                _858 = _854.z;
            }
            else
    ...
    if (_904)
    {
        ...
        float4 _988 = round(_37.SampleLevel(_15, (floor(clamp(_894 * _937, 0.5f.xx, (_937 - 0.5f).xx) + float2(float(_931 & 1023u), float((_931 >> 10u) & 1023u))) + 0.5f.xx) * _22_m6.w, _973) * 255.0f);
        ...
        if (((_994 & _999) + ((_996 & _999) << _1004)) == _24_m3.w)
        {
            ...
            _44.Store(((_24_m4.x + uint(((_994 >> _1004) + ((_996 >> _1004) * _24_m2.z)) << 2)) >> 2u) * 4 + 0, (((2147483648u | uint(_1019 << 24)) | (uint(_910) << 16u)) | (_1026.y << 8u)) | _1026.x);
        }
        _1051 = _988;
        _1052 = _948;
        _1053 = _946;
    ...
    float4 _1196 = _29.SampleLevel(_16, _1191.xy, 0.0f);
    ...
    if (_904 && _1054)
    {
        ...
        float4 _1268 = _38.SampleGrad(_42, _1251, _1265, _1266);
        float4 _1288;
        if (_22_m17 > 0.0f)
        {
            float4 _1282 = _39.SampleGrad(_42, _1251, _1265, _1266);
            float4 _1286 = _40.SampleGrad(_42, _1251, _1265, _1266);
            _1288 = float4(_1282.x, _1282.y, _1286.x, _1286.y);
        }
        else
        {
            _1288 = _39.SampleGrad(_42, _1251, _1265, _1266);
        }
        float4 _1292 = _41.SampleGrad(_42, _1251, _1265, _1266);
    ...
    else
    {
        ...
        _1317 = _1196.z;
        _1318 = _1196.w;
        _1319 = _30.SampleLevel(_16, _1191.zw, 0.0f).xyz;
        _1320 = _1206;
        _1321 = clamp(_31.SampleLevel(_16, ((_1137 + (((floor(_1149) + clamp(frac(_1149), (0.5f / _1143).xx, ((_1143 - 0.5f) * (1.0f / _1143)).xx)) / _1148.xx) * _22_m0.w)) + _22_m1.w.xx) * _1120, 0.0f).w - 0.5f, 0.0f, 1.0f);
    }
    float3 _1388;
    ...
    uint2 _1621 = uint2(floor((_33.SampleLevel(_15, _22_m8.zw * (_1582 + float2(float(_1605 & 1u), float(_1605 >> 1u))), 0.0f).xy * 255.5f) * 0.25f.xx));
    uint _1622 = _1621.y;
    float4 _1631 = _32.SampleLevel(_16, _1191.zw, 0.0f);
    float _1632 = _1631.w;
    ...
    float4 _1687 = _34.SampleGrad(_17, _1683, _1677.xy, _1677.zw);
    float4 _1691 = _35.SampleGrad(_17, _1683, _1677.xy, _1677.zw);
