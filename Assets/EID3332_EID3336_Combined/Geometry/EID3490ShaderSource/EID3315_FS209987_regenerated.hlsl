...
Texture2D<float4> _33 : register(t9);
SamplerState _34 : register(s1);
Texture2D<float4> _35 : register(t2);
SamplerState _36 : register(s0);
Texture2D<float4> _37 : register(t3);
Texture2D<float4> _38 : register(t7);
Texture2D<float4> _39 : register(t4);
Texture2D<float4> _40 : register(t8);
Texture2D<float4> _41 : register(t6);
Texture2D<float4> _42 : register(t5);
Texture2D<float4> _53 : register(t29);
Texture2D<float4> _54 : register(t32);
Texture2D<float4> _55 : register(t11);
Texture2D<float4> _56 : register(t21);
Texture2D<float4> _57 : register(t31);
Texture2DArray<float4> _58 : register(t23);
Texture2DArray<float4> _59 : register(t28);
Texture2D<float4> _60 : register(t22);
Texture2D<float4> _61 : register(t30);
Texture2D<float4> _62 : register(t27);
Texture2D<float4> _63 : register(t26);
Texture2D<float4> _64 : register(t25);
Texture2D<float4> _65 : register(t24);
...
void frag_main()
{
    ...
    float _1709 = clamp(float(int(sign(max(_24_m0[_11]._m1.y, _24_m0[_11]._m1.z) + (-0.10000002384185791015625f)))), 0.0f, 1.0f);
