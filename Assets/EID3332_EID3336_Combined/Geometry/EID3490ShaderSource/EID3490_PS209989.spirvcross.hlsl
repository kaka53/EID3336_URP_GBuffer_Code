...
cbuffer _22_24 : register(b0)
{
    _23 _24_m0[256] : packoffset(c0);
};

cbuffer _42_43 : register(b9)
{
...
SamplerState _26 : register(s8);
SamplerState _27 : register(s10);
SamplerState _28 : register(s9);
SamplerState _29 : register(s5);
SamplerState _30 : register(s20);
Texture2D<float4> _33 : register(t8);
SamplerState _34 : register(s1);
Texture2D<float4> _35 : register(t2);
SamplerState _36 : register(s0);
Texture2D<float4> _37 : register(t3);
Texture2D<float4> _38 : register(t6);
Texture2D<float4> _39 : register(t7);
Texture2D<float4> _40 : register(t5);
Texture2D<float4> _41 : register(t4);
Texture2D<float4> _52 : register(t29);
Texture2D<float4> _53 : register(t32);
Texture2D<float4> _54 : register(t11);
Texture2D<float4> _55 : register(t21);
Texture2D<float4> _56 : register(t31);
Texture2DArray<float4> _57 : register(t23);
Texture2DArray<float4> _58 : register(t28);
Texture2D<float4> _59 : register(t22);
Texture2D<float4> _60 : register(t30);
Texture2D<float4> _61 : register(t27);
Texture2D<float4> _62 : register(t26);
Texture2D<float4> _63 : register(t25);
Texture2D<float4> _64 : register(t24);
...
void frag_main()
{
    ...
    float3 _1694;
    [branch]
    if ((_21_m4.w == 0.0f) && (_339 < 128.0f))
    {
        float4 _821 = _59.SampleLevel(_30, _320, 0.0f);
        float _822 = _821.x;
        ...
        if (min(_838, _847) < 0.999000012874603271484375f)
        {
            ...
            if (_869)
            {
                ...
                if (_907)
                {
                    ...
                    float4 _991 = round(_60.SampleLevel(_26, (floor(clamp(_891 * _940, 0.5f.xx, (_940 - 0.5f).xx) + float2(float(_934 & 1023u), float((_934 >> 10u) & 1023u))) + 0.5f.xx) * _47_m6.w, floor(clamp(lerp((0.5f * log2(max(_963, _964))) - _965, (0.5f * log2(min(_963, _964))) - _965, 0.449999988079071044921875f), 0.0f, _937))) * 255.0f);
                ...
                float4 _1139 = _52.SampleLevel(_27, _1134.xy, 0.0f);
                ...
                if (_907 && _997)
                {
                    ...
                    float4 _1203 = _61.SampleLevel(_27, _1194, 0.0f);
                    float4 _1223;
                    if (_47_m17 > 0.0f)
                    {
                        float4 _1217 = _62.SampleLevel(_27, _1194, 0.0f);
                        float4 _1221 = _63.SampleLevel(_27, _1194, 0.0f);
                        _1223 = float4(_1217.x, _1217.y, _1221.x, _1221.y);
                    }
                    else
                    {
                        _1223 = _62.SampleLevel(_27, _1194, 0.0f);
                    }
                    float4 _1227 = _64.SampleLevel(_27, _1194, 0.0f);
                ...
                else
                {
                    ...
                    _1252 = _1139.z;
                    _1253 = _1139.w;
                    _1254 = _53.SampleLevel(_27, _1134.zw, 0.0f).xyz;
                    _1255 = _1149;
                    _1256 = clamp(_54.SampleLevel(_27, ((_1080 + (((floor(_1092) + clamp(frac(_1092), (0.5f / _1086).xx, ((_1086 - 0.5f) * (1.0f / _1086)).xx)) / _1091.xx) * _47_m0.w)) + _47_m1.w.xx) * _1063, 0.0f).w - 0.5f, 0.0f, 1.0f);
                }
                ...
                uint2 _1468 = uint2(floor((_56.SampleLevel(_26, _47_m8.zw * (_1429 + float2(float(_1452 & 1u), float(_1452 >> 1u))), 0.0f).xy * 255.5f) * 0.25f.xx));
                uint _1469 = _1468.y;
                float4 _1478 = _55.SampleLevel(_27, _1134.zw, 0.0f);
                float _1479 = _1478.w;
                ...
                float4 _1534 = _57.SampleGrad(_29, _1530, _1524.xy, _1524.zw);
                float4 _1538 = _58.SampleGrad(_29, _1530, _1524.xy, _1524.zw);
    ...
    float _1704 = clamp(float(int(sign(max(_24_m0[_11]._m1.y, _24_m0[_11]._m1.z) + (-0.10000002384185791015625f)))), 0.0f, 1.0f);
