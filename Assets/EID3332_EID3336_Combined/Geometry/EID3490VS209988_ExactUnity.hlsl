#ifndef EID3490_VS209988_EXACT_UNITY_INCLUDED
#define EID3490_VS209988_EXACT_UNITY_INCLUDED

// Exact SPIRV-Cross translation of captured VS resource 209988. RenderDoc raw SPIR-V SHA256 matches resource 209986 byte-for-byte.
...
void EID3336_VS_MainBody()
{
    ...
    do
    {
        ...
        uint VS_213 = asuint(VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m1.w);
        ...
        uint4 VS_231 = (asuint(VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m2.x) + 3u).xxxx + VS_230;
        uint4 VS_233 = (asuint(VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m2.y) + 3u).xxxx + VS_230;
    ...
    float3x3 VS_407 = float3x3(VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m0[0].xyz, VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m0[1].xyz, VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m0[2].xyz);
    float3 VS_417 = mul(VS_407, VS_396) + (float3(VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m0[0].w, VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m0[1].w, VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m0[2].w) - VS_25_m11.xyz);
    float3 VS_426 = mul(VS_407, float3(1.0f / dot(VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m0[0].xyz, VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m0[0].xyz), 1.0f / dot(VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m0[1].xyz, VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m0[1].xyz), 1.0f / dot(VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m0[2].xyz, VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m0[2].xyz)) * VS_398);
    float3 VS_432 = mul(VS_407, VS_395.xyz);
    float4 VS_453 = mul(VS_25_m8, float4(VS_417, 1.0f));
    float2 VS_461 = VS_453.xy - ((VS_27_m9.zw * float2(2.0f, -2.0f)) * VS_453.w);
    float4 VS_462 = float4(VS_461.x, VS_461.y, VS_453.z, VS_453.w);
    bool3 VS_467 = (VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m4.x < 1.0f).xxx;
    bool4 VS_473 = (VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m4.y < 1.0f).xxxx;
    float4 VS_482 = float4(VS_417 + (VS_25_m11.xyz - VS_25_m21.xyz), 1.0f);
    float4 VS_502 = float4(mul(float3x3(VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m3[0].xyz, VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m3[1].xyz, VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m3[2].xyz), float3(VS_467.x ? VS_396.x : VS_397.xyz.x, VS_467.y ? VS_396.y : VS_397.xyz.y, VS_467.z ? VS_396.z : VS_397.xyz.z)) + (float3(VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m3[0].w, VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m3[1].w, VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m3[2].w) - VS_25_m21.xyz), 1.0f);
    VS_462.y = VS_461.y;
    ...
    VS_19 = float4(VS_432 * rsqrt(max(1.1754943508222875079687365372222e-38f, dot(VS_432, VS_432))), VS_395.w * ((VS_30_m0[uint(EID3336_VS_InstanceIndex)]._m2.w >= 0.0f) ? 1.0f : (-1.0f)));
    VS_21 = VS_453.xyw;
    VS_22 = mul(VS_25_m15, float4(VS_473.x ? VS_482.x : VS_502.x, VS_473.y ? VS_482.y : VS_502.y, VS_473.z ? VS_482.z : VS_502.z, VS_473.w ? VS_482.w : VS_502.w)).xyw;
    VS_23 = uint(EID3336_VS_InstanceIndex);
}

EID3336_VS_Output EID3336ExactVSCore(EID3336_VS_Input stage_input)
{
    EID3336_VS_InstanceIndex = _EID3336InstanceIndex;
