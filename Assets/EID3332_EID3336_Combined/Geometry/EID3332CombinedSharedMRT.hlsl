#ifndef EID3336_SCENE_FIVE_MRT_INCLUDED
#define EID3336_SCENE_FIVE_MRT_INCLUDED

#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Core.hlsl"
#include "EID3332CombinedVS209986_ExactUnity.hlsl"
#include "EID3332CombinedPS209987_ExactUnity.hlsl"
...
EID3336_VS_Input EID3336BuildSceneVSInput(EID3336SceneAttributes input)
{
    ...
    capturedInput.VS_12 = (uint4)round(input.uv5);
...
EID3336_VS_Output EID3336ScenePreviewVertexProcedural(uint vertexId : SV_VertexID)
{
    ...
    float3 positionWS = mul(
        EID3336RouteBGetInstanceRecord()._m0,
...
SPIRV_Cross_Output EID3336RunScenePS(EID3336_VS_Output input, bool frontFace)
{
    ...
    return EID3336ExactPS(capturedInput);
}
...
EID3336SceneMRTOutput EID3336PackSceneMRT(SPIRV_Cross_Output captured)
{
    ...
    // Exact RenderDoc contract: RT4 is PS209987 output _16 byte-for-byte.
    // No Unity-side tint, intensity, color-space correction or post multiply.
