#ifndef EID3336_VS209986_EXACT_UNITY_INCLUDED
#define EID3336_VS209986_EXACT_UNITY_INCLUDED
...
void EID3336_VS_MainBody()
{
    ...
    do
    {
        ...
        uint VS_213 = asuint(EID3336RouteBGetInstanceRecord()._m1.w);
        ...
        uint4 VS_231 = (asuint(EID3336RouteBGetInstanceRecord()._m2.x) + 3u).xxxx + VS_230;
        uint4 VS_233 = (asuint(EID3336RouteBGetInstanceRecord()._m2.y) + 3u).xxxx + VS_230;
    ...
    float3x3 VS_407 = float3x3(EID3336RouteBGetInstanceRecord()._m0[0].xyz, EID3336RouteBGetInstanceRecord()._m0[1].xyz, EID3336RouteBGetInstanceRecord()._m0[2].xyz);
    float3 VS_417 = mul(VS_407, VS_396) + (float3(EID3336RouteBGetInstanceRecord()._m0[0].w, EID3336RouteBGetInstanceRecord()._m0[1].w, EID3336RouteBGetInstanceRecord()._m0[2].w) - VS_25_m11.xyz);
    float3 VS_426 = mul(VS_407, float3(1.0f / dot(EID3336RouteBGetInstanceRecord()._m0[0].xyz, EID3336RouteBGetInstanceRecord()._m0[0].xyz), 1.0f / dot(EID3336RouteBGetInstanceRecord()._m0[1].xyz, EID3336RouteBGetInstanceRecord()._m0[1].xyz), 1.0f / dot(EID3336RouteBGetInstanceRecord()._m0[2].xyz, EID3336RouteBGetInstanceRecord()._m0[2].xyz)) * VS_398);
    ...
    bool3 VS_467 = (EID3336RouteBGetInstanceRecord()._m4.x < 1.0f).xxx;
    bool4 VS_473 = (EID3336RouteBGetInstanceRecord()._m4.y < 1.0f).xxxx;
    float4 VS_482 = float4(VS_417 + (VS_25_m11.xyz - VS_25_m21.xyz), 1.0f);
    float4 VS_502 = float4(mul(float3x3(EID3336RouteBGetInstanceRecord()._m3[0].xyz, EID3336RouteBGetInstanceRecord()._m3[1].xyz, EID3336RouteBGetInstanceRecord()._m3[2].xyz), float3(VS_467.x ? VS_396.x : VS_397.xyz.x, VS_467.y ? VS_396.y : VS_397.xyz.y, VS_467.z ? VS_396.z : VS_397.xyz.z)) + (float3(EID3336RouteBGetInstanceRecord()._m3[0].w, EID3336RouteBGetInstanceRecord()._m3[1].w, EID3336RouteBGetInstanceRecord()._m3[2].w) - VS_25_m21.xyz), 1.0f);
    VS_462.y = VS_461.y;
    ...
    VS_19 = float4(VS_432 * rsqrt(max(1.1754943508222875079687365372222e-38f, dot(VS_432, VS_432))), VS_395.w * ((EID3336RouteBGetInstanceRecord()._m2.w >= 0.0f) ? 1.0f : (-1.0f)));
    VS_21 = VS_453.xyw;
