Shader "Reconstructed/EID3490 VS209988 PS209989 MRT"
{
    Properties
    {
        [NoScaleOffset] _33 ("Set1 B9 Base Color - RID271247", 2D) = "white" {}
        [NoScaleOffset] _35 ("Set1 B2 Base Normal - RID227040", 2D) = "bump" {}
        [NoScaleOffset] _37 ("Set1 B3 Layer Control - RID226998", 2D) = "black" {}
        [NoScaleOffset] _38 ("Set1 B6 Detail/Blend Normal - RID279400", 2D) = "bump" {}
        [NoScaleOffset] _39 ("Set1 B7 Mask - RID204", 2D) = "black" {}
        [NoScaleOffset] _40 ("Set1 B5 Secondary Color - RID197598", 2D) = "white" {}
        [NoScaleOffset] _41 ("Set1 B4 Secondary Mask - RID198094", 2D) = "white" {}
        [NoScaleOffset] _42 ("Unused by PS209989", 2D) = "bump" {}
