...
struct EID3863VertexInput { float3 position : POSITION; float3 normal : NORMAL; float4 tangent : TANGENT; float4 color : COLOR; float2 uv0 : TEXCOORD0; float2 uv1 : TEXCOORD1; float2 uv2 : TEXCOORD2; UNITY_VERTEX_INPUT_INSTANCE_ID };
EID3863VertexVaryings EID3863VertexMain(EID3863VertexInput i) { EID3863VSInputInternal x; x.VSX3=i.position; x.VSX4=i.normal; x.VSX5=i.tangent; x.VSX6=i.color; x.VSX7=i.uv0; x.VSX8=i.uv1; x.VSX9=i.uv2; x.VSglXInstanceIndex=0u; return EID3863VSGeneratedMain(x); }
