...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed partial class UniversalRenderer : ScriptableRenderer
    {
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            // Select the source-level attachment contract before any
            // renderingModeActual query; ResolveMixedLightingMode allocates
            // the GBuffer array later in this method.
            bool useEID3336FiveMRT = m_DeferredLights != null && QueryEID3336FiveMRT(camera);
            if (m_DeferredLights != null)
                m_DeferredLights.UseEID3336FiveMRT = useEID3336FiveMRT;
            ...
            if (m_DeferredLights != null)
            {
                ...
                // This must be decided before ResolveMixedLightingMode(),
                // because that call allocates the GBuffer attachment array.
                m_DeferredLights.UseEID3336FiveMRT = useEID3336FiveMRT;
                    // The recovered attachments are sampled by the custom B6
                // shader, so keep the classic URP attachment path. Native
                // render-pass input attachments are not shader-readable in
                // the same way on D3D11 and can expose stale/undefined data.
