...
EIDS = [3583]
FAMILY = 'VS243940_PS243941'
EXPECTED = (243940, 243941)
INSTANCE_STRIDE = 256
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS243940_PS243941_Batch'
...
UNIQUE_MATERIAL = {'res27', 'res29', 'res31', 'res33', 'res35'}
...
SSBO_SRC = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS229074_PS229075_Batch/Captured/CBuffers/VS_00_ssbo30_8917ef5d197f9a03.bytes'
...
def work(c):
    ...
    vs_spv = open(os.path.join(SHADER_SRC, '9bfd93b2c33c7fc3_VS.spv'), 'rb').read()
    vs_asm = open(os.path.join(SHADER_SRC, '9bfd93b2c33c7fc3_VS.spvasm'), 'rb').read()
    ps_spv = open(os.path.join(SHADER_SRC, 'f0868f92cd5e06d0_PS.spv'), 'rb').read()
    ps_asm = open(os.path.join(SHADER_SRC, 'f0868f92cd5e06d0_PS.spvasm'), 'rb').read()
    shader_files = {
        'VS243940': {
            'spv': save(os.path.join(SH, 'VS243940.spv'), vs_spv),
            'disassembly': save(os.path.join(SH, 'VS243940.spvasm'), vs_asm),
            'sha256': hashlib.sha256(vs_spv).hexdigest(),
        },
        'PS243941': {
            'spv': save(os.path.join(SH, 'PS243941.spv'), ps_spv),
            'disassembly': save(os.path.join(SH, 'PS243941.spvasm'), ps_asm),
    ...
    existing = {}
    search_roots = [
        os.path.join(ASSETS, 'ColourPass6_VS243940_PS243941_Batch', 'TextureDatabase'),
        os.path.join(ASSETS, 'ColourPass6_VS241568_PS241569_Batch', 'TextureDatabase'),
    ...
    out = {
        ...
        'notes': {
            ...
            'localMaterialCB': 'PS uniforms41 592B packed _P00.._P36',
            'materialIdCB': 'PS uniforms43 16B',
            'mipBias': 'PS uniforms20 child16 @416',
            'skinning': 'flags 52 bit32 set; reuse Combined ssbo30 8917ef5d without hashing inside Eval',
            'raster': raster,
            'liveUnityVP': True,
            ...
            'vsSha256': shader_files['VS243940']['sha256'],
            'psSha256': shader_files['PS243941']['sha256'],
        },
        'profiles': profiles,
    ...
    open(os.path.join(ROOT, 'VS243940_PS243941_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
    result_path = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/export_241568_241569_batch_result.json'
    summary = {
