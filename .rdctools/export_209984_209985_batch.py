...
EIDS = [3008, 3010, 3012, 3014, 3016, 3020, 3022, 3024, 3026, 3030, 3032, 3034, 3036, 3041, 3045, 3050, 3052, 3054, 3059]
FAMILY = 'VS209984_PS209985'
EXPECTED = (209984, 209985)
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS209984_PS209985_Batch'
...
UNIQUE_MATERIAL = {'res24', 'res26', 'res28'}
...
def work(c):
    ...
    shader_files = {}
    for stage, key in [(rd.ShaderStage.Vertex, 'VS209984'), (rd.ShaderStage.Pixel, 'PS209985')]:
        refl = s.GetShaderReflection(stage)
        shader_files[key] = {
    ...
    open(os.path.join(ROOT, 'VS209984_PS209985_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
    result_path = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/export_209984_209985_batch_result.json'
    summary = {
