...
EIDS = [3680, 3684, 3689]
FAMILY = 'VS215541_PS215542'
EXPECTED = (215541, 215542)
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS215541_PS215542_Batch'
...
UNIQUE_MATERIAL = {'res25', 'res27', 'res31'}
SHARED_REQUIRED = set()
...
def work(c):
    ...
    shader_files = {}
    for stage, key in [(rd.ShaderStage.Vertex, 'VS215541'), (rd.ShaderStage.Pixel, 'PS215542')]:
        refl = s.GetShaderReflection(stage)
        shader_files[key] = {
    ...
    out = {
        ...
        'notes': {
            ...
            'localMaterialCB': 'PS uniforms30 / VS uniforms33 320B',
    ...
    open(os.path.join(ROOT, 'VS215541_PS215542_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
    result_path = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/export_215541_215542_batch_result.json'
    summary = {
