...
EIDS = [1766, 1770]
OUT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/dump_215481_215482.json'
CBS = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/dump_215481_cbs.json'
INSTANCE_NAMES = ('uniforms26',)
        ...
        def stage_cbs(stage, key):
            ...
            for i, u in enumerate(s.GetConstantBlocks(stage)):
                ...
                if name in INSTANCE_NAMES and sz >= 256:
                    ...
                    rec['sha'] = hexhash(raw)[:16]
                    if name in ('uniforms11', 'uniforms33', 'uniforms6') or sz in (336, 352, 16, 32):
