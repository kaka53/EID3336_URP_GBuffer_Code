...
EIDS = [3626, 3631, 3636, 3640, 3644, 3648, 3652, 3656, 3660, 3664]
FAMILY = 'VS209992_PS209993'
EXPECTED = (209992, 209993)
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS209992_PS209993_Batch'
...
def work(c):
    ...
    shader_files = {}
    for stage, key in [(rd.ShaderStage.Vertex, 'VS209992'), (rd.ShaderStage.Pixel, 'PS209993')]:
        refl = s.GetShaderReflection(stage)
        shader_files[key] = {
    ...
    out = {
        ...
        'notes': {
            ...
            'localMaterialCB': 'PS uniforms30 368B',
    ...
    open(os.path.join(ROOT, 'VS209992_PS209993_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
    result_path = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/export_209992_209993_batch_result.json'
    summary = {
