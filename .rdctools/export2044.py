...
OUT=r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/EID3332_EID3336_Combined/EID2044_RenderDoc/Captured'
...
def work(c):
 eid=2044;c.SetFrameEvent(eid,True);s=c.GetPipelineState();p=s.GetGraphicsPipelineObject()
 # action
 act=None
 def walk(xs):
  nonlocal act
 ...
 open(os.path.join(OUT,'EID2044_capture_profile.json'),'w',encoding='utf-8').write(json.dumps(meta,indent=2,default=str))
