...
EIDS = [1717, 1721]
OUT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/dump_215452_215453.json'
CBS = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/dump_215452_cbs.json'
    ...
    for eid in EIDS:
        ...
        def stage_cbs(stage, key):
            ...
            for i, u in enumerate(s.GetConstantBlocks(stage)):
                ...
                if name in ('uniforms25', 'uniforms19') and sz >= 256:
                    ...
                    rec['sha'] = hexhash(raw)[:16]
                    if name in ('uniforms24', 'uniforms29', 'uniforms16') or sz in (304, 320, 16, 32):
