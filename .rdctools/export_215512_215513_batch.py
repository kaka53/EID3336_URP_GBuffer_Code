...
EIDS = [3204, 3208, 3212, 3217, 3222, 3226]
FAMILY = 'VS215512_PS215513'
EXPECTED = (215512, 215513)
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS215512_PS215513_Batch'
...
def work(c):
    ...
    shader_files = {}
    for stage, key in [(rd.ShaderStage.Vertex, 'VS215512'), (rd.ShaderStage.Pixel, 'PS215513')]:
        refl = s.GetShaderReflection(stage)
        shader_files[key] = {
    ...
    out = {
        ...
        'notes': {
            ...
            'instanceBuffer': 'VS uniforms29 / PS uniforms24 stride 256',
            'localMaterialCB': 'PS uniforms32 448B',
            'materialIdCB': 'PS uniforms34 16B child3',
            'mipBias': 'PS uniforms21 child16 @416; time child14.w @396; globalY child20.y @436; useViewForward child4.w @76',
            'skinning': 'flags bit32 all zero; ssbo31 not baked',
            'raster': raster,
            'liveUnityVP': True,
    ...
    open(os.path.join(ROOT, 'VS215512_PS215513_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
    result_path = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/export_215512_215513_batch_result.json'
    summary = {
