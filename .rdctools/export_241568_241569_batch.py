...
EIDS = [3567]
FAMILY = 'VS241568_PS241569'
EXPECTED = (241568, 241569)
INSTANCE_STRIDE = 256
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS241568_PS241569_Batch'
...
UNIQUE_MATERIAL = {'res30', 'res32', 'res34'}
...
def work(c):
    ...
    ps_spv = open(os.path.join(SHADER_SRC, '474c7cb928af681c_PS.spv'), 'rb').read()
    ps_asm = open(os.path.join(SHADER_SRC, '474c7cb928af681c_PS.spvasm'), 'rb').read()
    shader_files = {
        'VS241568': {
            'spv': save(os.path.join(SH, 'VS241568.spv'), vs_spv),
            'disassembly': save(os.path.join(SH, 'VS241568.spvasm'), vs_asm),
            'sha256': hashlib.sha256(vs_spv).hexdigest(),
        },
        'PS241569': {
            'spv': save(os.path.join(SH, 'PS241569.spv'), ps_spv),
            'disassembly': save(os.path.join(SH, 'PS241569.spvasm'), ps_asm),
    ...
    out = {
        ...
        'notes': {
            ...
            'localMaterialCB': 'PS uniforms37 432B packed _P00.._P26',
            ...
            'vsSha256': shader_files['VS241568']['sha256'],
            'psSha256': shader_files['PS241569']['sha256'],
        },
        'profiles': profiles,
    ...
    open(os.path.join(ROOT, 'VS241568_PS241569_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
