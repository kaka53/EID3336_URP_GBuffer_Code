...
def work(c):
 ...
 for eid in EIDS:
  ...
  if (vs,ps)!=(209980,209981):raise RuntimeError('EID%d shader mismatch %d/%d'%(eid,vs,ps))
 ...
 open(os.path.join(ROOT,'VS209980_PS209981_BatchManifest.json'),'w',encoding='utf8').write(json.dumps(out,indent=2,default=str))
