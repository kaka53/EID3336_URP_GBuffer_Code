...
EIDS = [2528, 2533]
OUT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/dump_215493_215494.json'
CBS = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/dump_215493_cbs.json'
INSTANCE_NAMES = ('uniforms28', 'uniforms20')
        ...
        def stage_cbs(stage, key):
            ...
            for i, u in enumerate(s.GetConstantBlocks(stage)):
                ...
                if name in INSTANCE_NAMES and sz >= 256:
                    ...
                    rec['sha'] = hexhash(raw)[:16]
                    if name in ('uniforms28', 'uniforms30', 'uniforms17', 'uniforms25') or sz in (16, 416, 3200, 496, 464):
