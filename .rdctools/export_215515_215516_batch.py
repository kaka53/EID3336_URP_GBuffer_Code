...
EIDS = [3388, 3393, 3398, 3402, 3406, 3410, 3414, 3418, 3422, 3426, 3430, 3434]
FAMILY = 'VS215515_PS215516'
EXPECTED = (215515, 215516)
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS215515_PS215516_Batch'
...
UNIQUE_MATERIAL = {'res34', 'res36', 'res37'}
SHARED_REQUIRED = {'res32'}
...
def work(c):
    ...
    shader_files = {}
    for stage, key in [(rd.ShaderStage.Vertex, 'VS215515'), (rd.ShaderStage.Pixel, 'PS215516')]:
        refl = s.GetShaderReflection(stage)
        shader_files[key] = {
    ...
    out = {
        ...
        'notes': {
            ...
            'localMaterialCB': 'PS uniforms39 608B',
    ...
    open(os.path.join(ROOT, 'VS215515_PS215516_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
    result_path = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/export_215515_215516_batch_result.json'
    summary = {
