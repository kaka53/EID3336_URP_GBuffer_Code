...
EIDS = [3237, 3241]
OUT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/dump_215496_215498.json'
CBS = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/dump_215496_cbs.json'
INSTANCE_NAMES = ('uniforms28', 'uniforms21')
        ...
        def stage_cbs(stage, key):
            ...
            for i, u in enumerate(s.GetConstantBlocks(stage)):
                ...
                if name in INSTANCE_NAMES and sz >= 256:
                    ...
                    rec['sha'] = hexhash(raw)[:16]
                    if name in ('uniforms34', 'uniforms29', 'uniforms31', 'uniforms21', 'uniforms18') or sz in (16, 32, 448, 3200):
