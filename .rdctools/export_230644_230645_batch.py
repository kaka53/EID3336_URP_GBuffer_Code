...
EIDS = [2583, 2587, 2591, 2595, 2599]
FAMILY = 'VS230644_PS230645'
EXPECTED = (230644, 230645)
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS230644_PS230645_Batch'
...
def work(c):
    ...
    shader_files = {}
    for stage, key in [(rd.ShaderStage.Vertex, 'VS230644'), (rd.ShaderStage.Pixel, 'PS230645')]:
        refl = s.GetShaderReflection(stage)
        shader_files[key] = {
    ...
    existing = {}
    search_roots = [
        os.path.join(ASSETS, 'ColourPass6_VS230646_PS230647_Batch', 'TextureDatabase'),
        os.path.join(ASSETS, 'ColourPass6_VS230644_PS230645_Batch', 'TextureDatabase'),
    ...
    open(os.path.join(ROOT, 'VS230644_PS230645_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
    result_path = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/export_230644_230645_batch_result.json'
    summary = {
