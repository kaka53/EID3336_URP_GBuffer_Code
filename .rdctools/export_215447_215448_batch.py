...
EIDS = [1603, 1608, 1613, 1662, 1667, 1677]
FAMILY = 'VS215447_PS215448'
EXPECTED = (215447, 215448)
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS215447_PS215448_Batch'
...
def work(c):
    ...
    shader_files = {}
    for stage, key in [(rd.ShaderStage.Vertex, 'VS215447'), (rd.ShaderStage.Pixel, 'PS215448')]:
        refl = s.GetShaderReflection(stage)
        shader_files[key] = {
    ...
    open(os.path.join(ROOT, 'VS215447_PS215448_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
    result_path = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/export_215447_215448_batch_result.json'
    summary = {
