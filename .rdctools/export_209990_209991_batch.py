...
EIDS = [3598, 3602, 3606]
FAMILY = 'VS209990_PS209991'
EXPECTED = (209990, 209991)
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS209990_PS209991_Batch'
...
def work(c):
    ...
    shader_files = {}
    for stage, key in [(rd.ShaderStage.Vertex, 'VS209990'), (rd.ShaderStage.Pixel, 'PS209991')]:
        refl = s.GetShaderReflection(stage)
        shader_files[key] = {
    ...
    out = {
        ...
        'notes': {
            ...
            'instanceBuffer': 'VS uniforms27 / PS uniforms23 stride 256',
            'localMaterialCB': 'PS uniforms31 368B',
    ...
    open(os.path.join(ROOT, 'VS209990_PS209991_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
    result_path = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/export_209990_209991_batch_result.json'
    summary = {
