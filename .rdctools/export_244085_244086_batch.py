...
EIDS = [3555]
FAMILY = 'VS244085_PS244086'
EXPECTED = (244085, 244086)
INSTANCE_STRIDE = 256
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS244085_PS244086_Batch'
...
UNIQUE_MATERIAL = {'res33', 'res35', 'res37', 'res38', 'res39', 'res40', 'res41', 'res42'}
...
def work(c):
    ...
    ps_spv = open(os.path.join(SHADER_SRC, '8688786ffe26e9bc_PS.spv'), 'rb').read()
    ps_asm = open(os.path.join(SHADER_SRC, '8688786ffe26e9bc_PS.spvasm'), 'rb').read()
    shader_files = {
        'VS244085': {
            'spv': save(os.path.join(SH, 'VS244085.spv'), vs_spv),
            'disassembly': save(os.path.join(SH, 'VS244085.spvasm'), vs_asm),
            'sha256': hashlib.sha256(vs_spv).hexdigest(),
        },
        'PS244086': {
            'spv': save(os.path.join(SH, 'PS244086.spv'), ps_spv),
            'disassembly': save(os.path.join(SH, 'PS244086.spvasm'), ps_asm),
    ...
    existing = {}
    search_roots = [
        os.path.join(ASSETS, 'ColourPass6_VS244085_PS244086_Batch', 'TextureDatabase'),
    ...
    out = {
        ...
        'notes': {
            ...
            'localMaterialCB': 'PS uniforms44 752B packed _P00.._P46',
            'materialIdCB': 'PS uniforms46 16B',
            ...
            'vsSha256': shader_files['VS244085']['sha256'],
            'psSha256': shader_files['PS244086']['sha256'],
        },
        'profiles': profiles,
    ...
    open(os.path.join(ROOT, 'VS244085_PS244086_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
    result_path = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/export_244085_244086_batch_result.json'
    summary = {
