...
EIDS = [3166, 3170, 3174, 3178, 3182, 3186, 3190, 3194, 3199]
FAMILY = 'VS215505_PS215507'
EXPECTED = (215505, 215507)
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS215505_PS215507_Batch'
...
def work(c):
    ...
    shader_files = {}
    for stage, key in [(rd.ShaderStage.Vertex, 'VS215505'), (rd.ShaderStage.Pixel, 'PS215507')]:
        refl = s.GetShaderReflection(stage)
        shader_files[key] = {
    ...
    out = {
        ...
        'notes': {
            ...
            'localMaterialCB': 'PS uniforms32 496B',
    ...
    open(os.path.join(ROOT, 'VS215505_PS215507_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
    result_path = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/export_215505_215507_batch_result.json'
    summary = {
