...
EIDS = [3064, 3068, 3070, 3074, 3076, 3078]
FAMILY = 'VS215495_PS215497'
EXPECTED = (215495, 215497)
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS215495_PS215497_Batch'
...
UNIQUE_MATERIAL = {'res27', 'res29', 'res31', 'res32'}
SHARED_REQUIRED = set()
...
def work(c):
    ...
    shader_files = {}
    for stage, key in [(rd.ShaderStage.Vertex, 'VS215495'), (rd.ShaderStage.Pixel, 'PS215497')]:
        refl = s.GetShaderReflection(stage)
        shader_files[key] = {
    ...
    out = {
        ...
        'notes': {
            ...
            'localMaterialCB': 'PS uniforms34 560B',
            'materialIdCB': 'PS uniforms36 16B child3',
    ...
    open(os.path.join(ROOT, 'VS215495_PS215497_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
    result_path = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/export_215495_215497_batch_result.json'
    summary = {
