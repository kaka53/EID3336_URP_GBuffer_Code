...
def work(c):
    ...
    shader_files = {
        'VS215525': {
            'spv': save(os.path.join(SH, 'VS215525.spv'), vs_spv),
            'disassembly': save(os.path.join(SH, 'VS215525.spvasm'), vs_asm),
            'sha256': hashlib.sha256(vs_spv).hexdigest(),
        },
        'PS215526': {
            'spv': save(os.path.join(SH, 'PS215526.spv'), ps_spv),
            'disassembly': save(os.path.join(SH, 'PS215526.spvasm'), ps_asm),
    ...
    out = {
        ...
        'notes': {
            ...
            'vsSha256': shader_files['VS215525']['sha256'],
            'psSha256': shader_files['PS215526']['sha256'],
        },
        'profiles': profiles,
    ...
    open(os.path.join(ROOT, 'VS215525_PS215526_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
