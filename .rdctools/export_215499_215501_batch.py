...
EIDS = [2538, 2542, 2547, 2552]
FAMILY = 'VS215499_PS215501'
EXPECTED = (215499, 215501)
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS215499_PS215501_Batch'
...
def work(c):
    ...
    shader_files = {}
    for stage, key in [(rd.ShaderStage.Vertex, 'VS215499'), (rd.ShaderStage.Pixel, 'PS215501')]:
        refl = s.GetShaderReflection(stage)
        shader_files[key] = {
    ...
    search_roots = [
        ...
        os.path.join(ASSETS, 'ColourPass6_VS215499_PS215501_Batch', 'TextureDatabase'),
    ...
    out = {
        ...
        'notes': {
            ...
            'localMaterialCB': 'PS uniforms30 496B',
    ...
    open(os.path.join(ROOT, 'VS215499_PS215501_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
    result_path = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/export_215499_215501_batch_result.json'
    summary = {
