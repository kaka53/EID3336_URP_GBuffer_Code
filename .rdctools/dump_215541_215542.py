...
EIDS = [3680, 3684, 3689]
OUT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/dump_215541_215542.json'
CBS = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/dump_215541_cbs.json'
        ...
        def stage_cbs(stage, key):
            ...
            for i, u in enumerate(s.GetConstantBlocks(stage)):
                ...
                if 0 < sz <= 65536:
                    ...
                    if name in ('uniforms30', 'uniforms33', 'uniforms32', 'uniforms20') or sz in (320, 32, 32864):
