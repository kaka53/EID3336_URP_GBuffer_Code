...
EIDS = [3261, 3265, 3269]
FAMILY = 'VS215506_PS215508'
EXPECTED = (215506, 215508)
ROOT = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/Assets/ColourPass6_VS215506_PS215508_Batch'
...
def work(c):
    ...
    shader_files = {}
    for stage, key in [(rd.ShaderStage.Vertex, 'VS215506'), (rd.ShaderStage.Pixel, 'PS215508')]:
        refl = s.GetShaderReflection(stage)
        shader_files[key] = {
    ...
    out = {
        ...
        'notes': {
            ...
            'localMaterialCB': 'PS uniforms38 464B',
            'skinning': 'flags bit32 all zero; ssbo30 not baked; skip dump when >1MB',
            'raster': raster,
            'liveUnityVP': True,
    ...
    open(os.path.join(ROOT, 'VS215506_PS215508_BatchManifest.json'), 'w', encoding='utf8').write(json.dumps(out, indent=2, default=str))
    result_path = r'D:/endcopy/EID3336_URP_GBuffer_Workspace/.rdctools/export_215506_215508_batch_result.json'
    summary = {
